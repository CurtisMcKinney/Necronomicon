...
{
    // assert(slab_1 != NULL && "NULL slab_1 in necro_unlink_slab");
    // assert(segment != NULL && "NULL segment in necro_unlink_slab");
    ...
    // if (slab_1 == segment->black_tail)
    //     segment->black_tail = prev;
    // if (slab_1 == segment->black)
    //     segment->black = next;
    // if (slab_1 == gc.gray)
    //     gc.gray = next;
    if (prev != NULL)
