...
NecroBase necro_base_create(NecroIntern* intern)
{
    return (NecroBase)
    {
        ...
        .tuple4_con             = necro_ast_symbol_empty,
        .tuple5_con             = necro_ast_symbol_empty,
        .tuple6_con             = necro_ast_symbol_empty,
        .tuple7_con             = necro_ast_symbol_empty,
        .tuple8_con             = necro_ast_symbol_empty,
        .tuple9_con             = necro_ast_symbol_empty,
        .tuple10_con            = necro_ast_symbol_empty,

        .tuple2_type            = necro_ast_symbol_empty,
        .tuple3_type            = necro_ast_symbol_empty,
        .tuple4_type            = necro_ast_symbol_empty,
        .tuple5_type            = necro_ast_symbol_empty,
        .tuple6_type            = necro_ast_symbol_empty,
        .tuple7_type            = necro_ast_symbol_empty,
        .tuple8_type            = necro_ast_symbol_empty,
        .tuple9_type            = necro_ast_symbol_empty,
        .tuple10_type           = necro_ast_symbol_empty,

        .poly_type              = necro_ast_symbol_empty,
        .world_type             = necro_ast_symbol_empty,
        .world_value            = necro_ast_symbol_empty,
        .unit_type              = necro_ast_symbol_empty,
        .unit_con               = necro_ast_symbol_empty,
        .list_type              = necro_ast_symbol_empty,
        .int_type               = necro_ast_symbol_empty,
        .float_type             = necro_ast_symbol_empty,
        .audio_type             = necro_ast_symbol_empty,
        .rational_type          = necro_ast_symbol_empty,
        .char_type              = necro_ast_symbol_empty,
        .bool_type              = necro_ast_symbol_empty,
        .num_type_class         = necro_ast_symbol_empty,
        .fractional_type_class  = necro_ast_symbol_empty,
        .eq_type_class          = necro_ast_symbol_empty,
        .ord_type_class         = necro_ast_symbol_empty,
        .functor_type_class     = necro_ast_symbol_empty,
        .applicative_type_class = necro_ast_symbol_empty,
        .monad_type_class       = necro_ast_symbol_empty,
        .event_type             = necro_ast_symbol_empty,
        .pattern_type           = necro_ast_symbol_empty,
        .closure_type           = necro_ast_symbol_empty,
        .apply_fn               = necro_ast_symbol_empty,
        .ptr_type               = necro_ast_symbol_empty,
        .array_type             = necro_ast_symbol_empty,
        .dyn_state_type         = necro_ast_symbol_empty,
        .maybe_type             = necro_ast_symbol_empty,

        .mouse_x_fn             = necro_ast_symbol_empty,
        .mouse_y_fn             = necro_ast_symbol_empty,
        .unsafe_malloc          = necro_ast_symbol_empty,
        .unsafe_peek            = necro_ast_symbol_empty,
        .unsafe_poke            = necro_ast_symbol_empty,
    };
}
...
NecroBase necro_base_compile(NecroIntern* intern, NecroScopedSymTable* scoped_symtable)
{
    ...
    // >>
    {
        ...
        NecroAst* op_lambda   = necro_ast_create_bin_op(arena, intern, ">>=",
            necro_ast_create_var(arena, intern, "m", NECRO_VAR_VAR),
        ...
        NecroAst* op_rhs      = necro_ast_create_rhs(arena, op_lambda, NULL);
    ...
    // <>
    {
        ...
        NecroAst* append_op_sig =
            necro_ast_create_fn_type_sig(arena, intern, "<>", necro_ast_create_context(arena, intern, "Semigroup", "a", NULL),
                necro_ast_create_type_fn(arena, a_var, necro_ast_create_type_fn(arena, a_var, a_var)),
                NECRO_VAR_SIG, NECRO_SIG_DECLARATION);
        NecroAst* append_def_ast  = necro_ast_create_simple_assignment(arena, intern, "<>", necro_ast_create_rhs(arena, necro_ast_create_var(arena, intern, "append", NECRO_VAR_VAR), NULL));
        necro_append_top(arena, top, append_op_sig);
        necro_append_top(arena, top, append_def_ast);
    }
