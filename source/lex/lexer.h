...
typedef enum
{
    ...
    NECRO_LEX_APPEND,
    NECRO_LEX_ADD_ON_LEFT,
    NECRO_LEX_ADD_ON_RIGHT,
    NECRO_LEX_SUB_ON_LEFT,
    NECRO_LEX_SUB_ON_RIGHT,
    NECRO_LEX_MUL_ON_LEFT,
    NECRO_LEX_MUL_ON_RIGHT,
    NECRO_LEX_DIV_ON_LEFT,
    NECRO_LEX_DIV_ON_RIGHT,
    NECRO_LEX_CONST_LEFT_ON_LEFT,
    NECRO_LEX_CONST_LEFT_ON_RIGHT,
    NECRO_LEX_CONST_RIGHT_ON_LEFT,
    NECRO_LEX_CONST_RIGHT_ON_RIGHT,
    NECRO_LEX_CONST_LEFT_ON_BOTH,
    NECRO_LEX_CONST_RIGHT_ON_BOTH,
    NECRO_LEX_DOUBLE_DIV,
    ...
    NECRO_LEX_UNBOXED_LEFT_PAREN,
    NECRO_LEX_UNBOXED_RIGHT_PAREN,
