...
void necro_mach_print_binop(NecroMachAst* ast, size_t depth)
{
    ...
    case NECRO_PRIMOP_BINOP_FDIV:    printf("fvdiv ");   break;
    case NECRO_PRIMOP_BINOP_FREM:    printf("fvrem ");   break;
    case NECRO_PRIMOP_BINOP_FVADD:   printf("fvadd ");   break;
    case NECRO_PRIMOP_BINOP_FVSUB:   printf("fvsub ");   break;
    case NECRO_PRIMOP_BINOP_FVMUL:   printf("fvmul ");   break;
    case NECRO_PRIMOP_BINOP_FVDIV:   printf("fvdiv ");   break;
    case NECRO_PRIMOP_BINOP_FVREM:   printf("fvrem ");   break;
...
void necro_mach_print_uop(NecroMachAst* ast, size_t depth)
{
    ...
    case NECRO_PRIMOP_UOP_ITOFV:        printf("itofv ");     break;
    ...
    case NECRO_PRIMOP_UOP_FTOFV:        printf("ftofv ");     break;
